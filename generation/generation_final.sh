...
python generate.py --ckpt ckpt/final.ckpt \
                   ...
                   --output output_final/8/cute_cat\
                   --sample_num 4 \
                   --cfg_scale 2.0 \
                   --elevation 30 \
                   --crop_size 200
...
python generate.py --ckpt ckpt/final.ckpt \
                   ...
                   --output output_final/8/portrait2\
                   --sample_num 4 \
                   --cfg_scale 2.0 \
                   --elevation 30 \
                   --crop_size 200
...
python generate.py --ckpt ckpt/final.ckpt \
                   ...
                   --output output_final/8/portrait3\
                   --sample_num 4 \
                   --cfg_scale 2.0 \
                   --elevation 30 \
                   --crop_size 200
...
python generate.py --ckpt ckpt/final.ckpt \
                   ...
                   --output output_final/8/rilakkuma1\
                   --sample_num 4 \
                   --cfg_scale 2.0 \
                   --elevation 30 \
                   --crop_size 200
...
python generate.py --ckpt ckpt/final.ckpt \
                   ...
                   --output output_final/8/rilakkuma2\
                   --sample_num 4 \
                   --cfg_scale 2.0 \
                   --elevation 30 \
                   --crop_size 200
...
python generate.py --ckpt ckpt/final.ckpt \
                   ...
                   --output output_final/8/rilakkuma3\
                   --sample_num 4 \
                   --cfg_scale 2.0 \
                   --elevation 30 \
                   --crop_size 200
